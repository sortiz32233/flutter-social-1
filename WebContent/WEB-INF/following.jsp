...
<head>
    ...
    <title>Flutter - ${displayUsername}'s Followed Users</title>
</head>
<body>
    <!-- Navbar -->
    ...
    <div class="jumbotron jumbotron-fluid">
        <div class="container">
            ...
            <p class="lead">${followingCount} Followed</p>
        </div>
    </div>
    ...
    <div class="container">
        <table class="table" style="text-align:center">
            ...
            <tbody>
	            <c:forEach items="${followingUsers}" var="fu">
	            	<tr class="clickable-row" data-href="/profile?${fu.getUID()}">
                        <td>${fu.getUID()}</td>
                        ...
                        <td>
                            <a class="btn btn-outline-danger btn-sm" href="/unfollow?${fu.getUID()}">Unfollow</a>
                        </td>
		           	</tr>
		        </c:forEach>
            </tbody>
